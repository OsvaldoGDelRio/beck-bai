...
if (!isset($_POST['frase1'])) {
    header('Location: http://localhost/beck-bai/web/index.php');
}
use src\Factory;
...
$scl = $factory->crear('src\factory\PruebaBeckBai', $formulario);
?>

<html>
    <head>
        <meta charset="utf-8">
        <title>Resultados prueba BECK:BAI - Síntomas de ansiedad</title>
